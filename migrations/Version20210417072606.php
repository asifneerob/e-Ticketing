 ...
 */
final class Version20210417072606 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE ticket_purchase_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE ticket_purchase_id_seq CASCADE');
